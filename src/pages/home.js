...
function renderCover(week, config) {
  ...
  return `
    <main class="cover">
      ...
      ${week.teaser ? `
        <h1 class="cover-headline" style="--d:.72s"><span class="cover-quote" aria-hidden="true">״</span>⁠${week.teaser.replace(/^(?:\s|<br\s*\/?>)+|(?:\s|<br\s*\/?>)+$/gi, '')}⁠<span class="cover-quote cover-quote-end" aria-hidden="true">״</span></h1>
      ` : `
